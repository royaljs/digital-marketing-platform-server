...
public class CampaignOutputDTO extends DataObject {
	private static final String DTO_LOGICAL_NAME = "CampaignOutputDTO";
	...
	public Object clone() {
		CampaignOutputDTO copyObj = new CampaignOutputDTO();	
		copyObj.clone(this);
		return copyObj;
	}
	
	public void clone(DataObject _CampaignOutputDTO) {
		if(this == _CampaignOutputDTO) return;
		CampaignOutputDTO __CampaignOutputDTO = (CampaignOutputDTO) _CampaignOutputDTO;
		this.setId(__CampaignOutputDTO.getId());
		this.setUserId(__CampaignOutputDTO.getUserId());
		this.setName(__CampaignOutputDTO.getName());
		this.setType(__CampaignOutputDTO.getType());
		this.setKeyword(__CampaignOutputDTO.getKeyword());
		this.setLastModified(__CampaignOutputDTO.getLastModified());
		this.setDateBegin(__CampaignOutputDTO.getDateBegin());
		this.setDateEnd(__CampaignOutputDTO.getDateEnd());
		this.setProductId(__CampaignOutputDTO.getProductId());	
		this.setContents(__CampaignOutputDTO.getContents());	
		this.setGoal(__CampaignOutputDTO.getGoal());
		this.setPlatform(__CampaignOutputDTO.getPlatform());
		this.setMaterial(__CampaignOutputDTO.getMaterial());
		this.setImageUuid(__CampaignOutputDTO.getImageUuid());
	}
	...
	public boolean equals(Object obj) {
		...
		CampaignOutputDTO _CampaignOutputDTO = (CampaignOutputDTO) obj;

		if(this.id == null) {
			if(_CampaignOutputDTO.getId() != null)
				return false;
		} else if(!this.id.equals(_CampaignOutputDTO.getId()))
			return false;
		if(this.user_id == null) {
			if(_CampaignOutputDTO.getUserId() != null)
				return false;
		} else if(!this.user_id.equals(_CampaignOutputDTO.getUserId()))
			return false;
		if(this.name == null) {
			if(_CampaignOutputDTO.getName() != null)
				return false;
		} else if(!this.name.equals(_CampaignOutputDTO.getName()))
			return false;
		if(this.type == null) {
			if(_CampaignOutputDTO.getType() != null)
				return false;
		} else if(!this.type.equals(_CampaignOutputDTO.getType()))
			return false;
		if(this.keyword == null) {
			if(_CampaignOutputDTO.getKeyword() != null)
				return false;
		} else if(!this.keyword.equals(_CampaignOutputDTO.getKeyword()))
			return false;
		if(this.last_modified == null) {
			if(_CampaignOutputDTO.getLastModified() != null)
				return false;
		} else if(!this.last_modified.equals(_CampaignOutputDTO.getLastModified()))
			return false;
		if(this.date_begin == null) {
			if(_CampaignOutputDTO.getDateBegin() != null)
				return false;
		} else if(!this.date_begin.equals(_CampaignOutputDTO.getDateBegin()))
			return false;
		if(this.date_end == null) {
			if(_CampaignOutputDTO.getDateEnd() != null)
				return false;
		} else if(!this.date_end.equals(_CampaignOutputDTO.getDateEnd()))
			return false;
		if(this.product_id == null) {
			if(_CampaignOutputDTO.getProductId() != null)
				return false;
		} else if(!this.product_id.equals(_CampaignOutputDTO.getProductId()))
			return false;
		if(this.contents == null) {
			if(_CampaignOutputDTO.getContents() != null)
				return false;
		} else if(!this.contents.equals(_CampaignOutputDTO.getContents()))
			return false;
		if(this.goal == null) {
			if(_CampaignOutputDTO.getGoal() != null)
				return false;
		} else if(!this.goal.equals(_CampaignOutputDTO.getGoal()))
			return false;
		if(this.platform == null) {
			if(_CampaignOutputDTO.getPlatform() != null)
				return false;
		} else if(!this.platform.equals(_CampaignOutputDTO.getPlatform()))
			return false;
		if(this.material == null) {
			if(_CampaignOutputDTO.getMaterial() != null)
				return false;
		} else if(!this.material.equals(_CampaignOutputDTO.getMaterial()))
			return false;
		if(this.image_uuid == null) {
			if(_CampaignOutputDTO.getImageUuid() != null)
				return false;
		} else if(!this.image_uuid.equals(_CampaignOutputDTO.getImageUuid()))
			return false;
		return true;
	}
