...
@ServiceObject
public class CampaignSODelete implements com.tmax.proobject.model.service.ServiceObject<com.tmax.hyperdm.dto.CampaignInputDTO, com.tmax.hyperdm.dto.CampaignOutputDTO>
{	
	...
	public com.tmax.hyperdm.dto.CampaignOutputDTO service(com.tmax.hyperdm.dto.CampaignInputDTO arg0) throws java.lang.Throwable
	{
		...
		logger.info("CampaignSODelete is called\n");
		logger.info("SO input DTO:\n" + arg0.toString());
		output = CampaignBO.deleteCampaign(arg0);
